...
│── requirements.txt     # It's an auto generated list of packages and dependent packages created via `pip-compile --output-file=- > requirements.txt`. DO NOT updated it manually.
```
